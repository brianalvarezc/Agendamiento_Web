...
public class Cita {
    ...
    private String cita_Entidad_Nombre;
    private int cita_Paciente_Id;
    private String cita_Paciente_Nombre;
    private int cita_Medico_Id;
    private String cita_Medico_Nombre;
    private int cita_Estado_Id;
    private String cita_Estado_Nombre;
    private int cita_Consultorio_Id;
    private String cita_Consultorio_Nombre;
    private String cita_Consultorio_Ubicacion;
    ////////////////////////////////////////////////////////////////////////////////
    // Constructores ////////////////////////////////////////
    public Cita() {
    }
    ...
    public String getCita_Entidad_Nombre() {
        return cita_Entidad_Nombre;
    }

    public void setCita_Entidad_Nombre(String cita_Entidad_Nombre) {
        this.cita_Entidad_Nombre = cita_Entidad_Nombre;
    }
    ...
    public String getCita_Paciente_Nombre() {
        return cita_Paciente_Nombre;
    }

    public void setCita_Paciente_Nombre(String cita_Paciente_Nombre) {
        this.cita_Paciente_Nombre = cita_Paciente_Nombre;
    }
    ...
    public String getCita_Medico_Nombre() {
        return cita_Medico_Nombre;
    }

    public void setCita_Medico_Nombre(String cita_Medico_Nombre) {
        this.cita_Medico_Nombre = cita_Medico_Nombre;
    }
    ...
    public String getCita_Consultorio_Nombre() {
        return cita_Consultorio_Nombre;
    }

    public void setCita_Consultorio_Nombre(String cita_Consultorio_Nombre) {
        this.cita_Consultorio_Nombre = cita_Consultorio_Nombre;
    }

    public String getCita_Consultorio_Ubicacion() {
        return cita_Consultorio_Ubicacion;
    }

    public void setCita_Consultorio_Ubicacion(String cita_Consultorio_Ubicacion) {
        this.cita_Consultorio_Ubicacion = cita_Consultorio_Ubicacion;
    }
